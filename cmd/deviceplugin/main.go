...
const (
	...
	resourceName         = "rmd.intel.com/l3_cache_ways"
...
func (test *testManager) discoverTestResources() error {
	devices, err := test.rmdClient.GetGuaranteedCacheWayPools()
	if err != nil {
		return err
	}
	for k, dev := range test.devices {
...
func (test *testManager) Start() error {
	glog.Infof("Discovering RMD guaranteed cache way[s]")
...
//func (test *testManager) GetPreferredAllocation(ctx context.Context, r *pluginapi.PreferredAllocationRequest) (*pluginapi.PreferredAllocationResponse, error) {
//	return nil, nil
//}
